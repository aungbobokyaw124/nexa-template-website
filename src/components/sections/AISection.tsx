      ...
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        <div style={{
          ...
          <div>
            ...
            }}>Your intelligent digital co-pilot.</h2>
            <p style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: isDark ? 'var(--color-surface)' : '#EFF6FF',
            }}>
              <div style={{
              ...
              <span style={{ color: 'var(--color-text)', fontSize: '14px', fontWeight: 600 }}>neXa AI</span>
              ...
              {loading && (
                <div style={{ marginBottom: '16px' }}>
                  ...
                  {['Planning', 'Designing', 'Generating'].map((step) => (
                    <div key={step} style={{
                      display: 'flex', alignItems: 'center', gap: '8px',
                      color: 'var(--color-primary)', fontSize: '13px', marginBottom: '8px',
                    }}>
                      <span>→</span> {step}...
                    </div>
                  ))}
            ...
            <div style={{
              ...
              background: isDark ? 'var(--color-surface)' : '#F8FAFF',
            }}>
              <input
                value={input}
